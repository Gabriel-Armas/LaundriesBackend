...
router.get('/ventas/por-fecha', verifyToken, checkRole(['MANAGER', 'ADMIN']), orderController.getSalesByDate);
...
router.patch('/item/:id/cancelar', verifyToken , checkRole(['MANAGER','ADMIN']),orderController.cancelOrder);
